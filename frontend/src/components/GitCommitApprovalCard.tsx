...
export default function GitCommitApprovalCard({ projectId, review, approval, onChanged }: { projectId: string; review: GitReview; approval?: { approval_id: string; payload_hash: string; status: string; payload?: { paths?: string[]; commit_message?: string } }; onChanged: () => void | Promise<void> }) {
